 ...
 * @author Omar
 */
class jReachableGraph extends JFrame{
    private JLabel text;
    private JButton[][] matrix_graph;
    private Icon tom;
    private Icon jerry;
    private Icon obstacle;
    private Icon icon_path;
    ...
    public jReachableGraph(){
        super("REACHABLE");
        String _content = "<html><FONT COLOR=BLUE>REACHABLE PATH</FONT>";
    ...
    public void init(){
        ...
        icon_path = new ImageIcon(getClass().getResource("/prfinal/res/images/path.png"));
        panel = new JPanel();
    ...
    private void setPathMatrix() {
        ...
        path.remove(0);
        for(Vertex v : path){
            matrix_graph[v.getCoordX()][v.getCoordY()].setIcon(icon_path);
        }
    }
